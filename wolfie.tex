...
tupla infoTítulo $\leftarrow$ <maxAcciones, accionesDisponibles, cot, enAlza>\\
...
\If{infoTítulo.cotización > cot}{infoTítulo.enAlza $\leftarrow$ false}
\Else{infoTítulo.enAlza $\leftarrow$ true}
